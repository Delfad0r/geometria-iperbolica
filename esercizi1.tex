...
\tkzDefPoint(0,0){p}
\tkzDefPointOnCircle[angle=95,center=p,radius=1]\tkzGetPoint{x_1}
\tkzDefPointOnCircle[angle=-15,center=p,radius=1]\tkzGetPoint{x_2}
\tkzDefPointOnCircle[angle=-15,center=p,radius=1]\tkzGetPoint{y_1}
\tkzDefPointOnCircle[angle=-100,center=p,radius=1]\tkzGetPoint{y_2}
\tkzDefPointOnCircle[angle=90,center=p,radius=1]\tkzGetPoint{p_1}
\tkzDefPointOnCircle[angle=-90,center=p,radius=1]\tkzGetPoint{p_2}
\tkzDefPointOnLine[pos=.4](p,p_1)\tkzGetPoint{p_3}
\foreach \name in {x,y} {
    \tkzDefPointWith[orthogonal](\name_1,p)\tkzGetPoint{\name_3}
    \tkzDefPointWith[orthogonal](\name_2,p)\tkzGetPoint{\name_4}
    \tkzInterLL(\name_1,\name_3)(\name_2,\name_4)\tkzGetPoint{\name_5}
    \tkzDrawArc(\name_5,\name_1)(\name_2)
}
\tkzInterLC(p_1,p_2)(x_5,x_1)\tkzGetFirstPoint{a_1}
\tkzInterLC(p_1,p_2)(y_5,y_1)\tkzGetSecondPoint{a_2}
\tkzInterCC(x_5,x_1)(y_5,y_1)\tkzGetSecondPoint{a_3}
\tkzInterLC(p,x_5)(x_5,x_1)\tkzGetFirstPoint{q}
\tkzDefPointOnCircle[angle=-30,center=p,radius=0.4]\tkzGetPoint{b}
\tkzFillSector[rotate,gray!5](p,p_1)(-180)
\tkzFillSector[rotate,blue!10](p,p_3)(-180)
\tkzDrawArc[rotate,blue,line width=0.7](p,p_3)(-180)
\tkzDrawSegment[gray](p_1,p_2)
\tkzDrawCircle[gray,R](p,1cm)
\tkzDrawArc[red,line width=0.7](x_5,a_1)(a_3)
\tkzDrawArc[red,line width=0.7](y_5,a_3)(a_2)
\tkzDrawSegment[red,line width=0.7](a_1,a_2)
\tkzDrawSegment[black,line width=0.7](p,q)
\tkzDrawSegment[blue,<->,>=stealth,shorten <=2pt](p,b)
\tkzDrawPoints[black](a_1,a_2,a_3)
\tkzDrawPoints[black](p,q)
\tkzLabelPoint[black,left](p){$p$}
\tkzLabelPoint[black,below](q){$q$}
\tkzLabelCircle[blue,right](p,p_3)(-110){$\mathcal{B}$}
\tkzLabelSegment[red,left,pos=0.6](p_1,p_2){$\ell$}
\tkzLabelCircle[black!70,below left](p,p_1)(-50){$\mathcal{A}$}
\tkzLabelSegment[blue,above](p,b){$K$}
\end{tikzpicture}
\end{figure}
\newpage
